    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="index.html">JobPost</a></div>
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="has-children">
                ...
                <ul class="dropdown">
                  <li><a href="job-single.html">See Jobs</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5">
            <h2 class="mb-4">Sign Up To JobPost</h2>
            <form action="loginprocess" method="post" class="p-4 border rounded">
            
              <div class="row form-group">
              	<label class="text-black" for="fname">${message}</label>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">User ID</label>
                  <input type="text" id="fname" class="form-control" placeholder="User ID" name="userid">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Password</label>
                  <input type="password" id="fname" class="form-control" placeholder="Password" name="passwd">
                </div>
              </div>
              <div class="row from-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Signup as -</label>
          ...
          <div class="col-lg-6">
            <h2 class="mb-4">Log In To JobPost</h2>
            <form action="loginprocess" method="post" class="p-4 border rounded">
              ...
              <div class="row form-group mb-4">
				...
				<div class="row from-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Sigin as -</label>
                  <select id="type" name="type">
                    <option value="Student">Student</option>
                    <option value="Company">Company</option>
                  </select>
